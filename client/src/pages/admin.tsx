...
import { ShieldCheck, Users, Activity, DollarSign } from "lucide-react";
...
export default function AdminPage() {
  ...
  const inactiveUsers = users?.filter(u => u.subscriptionStatus === "inactive").length || 0;
                      ...
                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                        ...
                        {user.paypalSubscriptionId && (
                          <span className="text-xs text-muted-foreground truncate max-w-[200px]">
                            PayPal: {user.paypalSubscriptionId}
                          </span>
                        )}
                      </div>
                    </div>
